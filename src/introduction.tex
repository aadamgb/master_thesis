...
Nonetheless, this solution comes with other problems since the resulting policies, learned in simulations, often perform worse than expected or fail to transfer to real-world scenarios altogether.
