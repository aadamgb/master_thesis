...
\definecolor{skyBlue}{HTML}{b4e5fe}
...
\newcommand{\refalg}[1]{\hyperref[#1]{Algortihm~\ref*{#1}}}
...
\pgfplotsset{
    empty axis/.style={
        axis lines=none,       % Remove all axis lines
        ticks=none,            % Remove all tick marks
        axis background/.style={fill=none}, % Remove background grid lines
        grid=none,              % Ensure grid is disabled
        xlabel={},              % Remove labels
        ylabel={},
        zlabel={},
    }
}
...
% Capitalize \autoref names (handles Babel overriding)
\addto\extrasenglish{%
