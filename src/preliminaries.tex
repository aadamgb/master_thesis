...
Learning-based approaches can be understood as an optimization methods in which the optimization process is done by intereacting with the environment.
There are two main types of \ac{RL}, model-based and model-free, each with their own advantages and drawbacks.
