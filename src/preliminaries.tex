...
\subsection{General Discrete-Time OCP}
...
\subsection{Minimum-Time OCP} \label{subsec:minOCP}
...
\subsection{Simplified Minimum-Time OCP}
...
\subsubsection{Trajectory Tracking OCP}
