...
\node [font=\fontsize{15.9pt}{20.7pt}\selectfont, fill={rgb,255:red,255; green,255; blue,255}, fill opacity=1, text opacity=1, inner xsep=0.080cm, inner ysep=0.085cm, rounded corners=0.020cm] at (7.125,4.375) {$v ,  \dot{\psi}$};
...
\node (tikzmaker) [shift={(1.5625, -1.25)}] at (10.75,20.125) {\includegraphics[width=3.125cm]{fig/photos/nn.png}};
