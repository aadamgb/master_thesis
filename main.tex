...
\newcommand{\Keywords}{Unmanned Aerial Vehicles, Autonomous Drone Racing, Reinforcement Learning, Simulation to Reality Transfer, Domain Randomization, Geometric Control.}
\newcommand{\KlicovaSlova}{Bezpilotní vzdušné prostředky, autonomní závody dronů, posilované učení, přenos ze simulace do reálného prostředí, doménová randomizace, geometrické řízení.}
\newcommand{\Year}{2026}
